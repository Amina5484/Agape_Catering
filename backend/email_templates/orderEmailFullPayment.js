const fullPaymentEmailHTML = (name, orderId, orderDate, items, totalAmount) => {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <p>Dear ${name},</p>
          <p>Thank you for your order. Your order <strong>#${orderId}</strong> placed on <strong>${orderDate}</strong> has been successfully received and paid in full.</p>
  ...
  export default fullPaymentEmailHTML;
