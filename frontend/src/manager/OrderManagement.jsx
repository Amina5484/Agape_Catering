              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                <div className="md:col-span-2 mt-2">
                  <button
                    ...
                    className="flex items-center px-3 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300 text-sm"
                  >
                    <FaMapMarkerAlt className="mr-1.5 w-3.5 h-3.5" />
                    View Location
                  </button>
                </div>
              </div>
                    ...
                    >
                      ...
                      <td className="px-1 py-1 whitespace-nowrap">
                        <select
                          ...
                          className={`px-0.5 py-0.5 rounded text-[7px] font-medium border ${
                            order.orderStatus === 'pending'
                              ? 'bg-yellow-50 border-yellow-200 text-yellow-800'
                              : order.orderStatus === 'confirmed'
                              ? 'bg-green-50 border-green-200 text-green-800'
