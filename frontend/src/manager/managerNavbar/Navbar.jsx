      ...
      <div className="px-4 md:px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 md:space-x-4">
          ...
          <div className="relative" ref={profileMenuRef}>
            ...
            {profileMenuOpen && (
              <div
                className={`absolute right-0 mt-2 w-60 py-2 rounded-lg shadow-lg transition-opacity duration-300 ease-in-out ${isDarkMode
              ...
              >
                <button
                  ...
                  className={`flex items-center w-full px-4 py-2 text-sm text-left text-crimson ${isDarkMode ? 'hover:bg-gray-700' : 'hover:bg-cloud'
                    }`}
                >
