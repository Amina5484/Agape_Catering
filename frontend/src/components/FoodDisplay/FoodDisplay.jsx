...
const FoodDisplay = () => {
  const { food_list, fetchFoodList, addToCart, isLoggedIn } = useContext(StoreContext);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 text-center mb-12">Our Menu</h1>
            ...
            <div key={category} className="mb-16">
              ...
              <div className="space-y-12">
                {Object.keys(categorizedFood[category]).map((subcategory) => (
                  <div key={subcategory} className="bg-white rounded-xl shadow-lg p-8">
                    <h3 className="text-2xl font-semibold text-gray-800 mb-6 text-center">{subcategory}</h3>
