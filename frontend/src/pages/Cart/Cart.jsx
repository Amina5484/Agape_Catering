 ...
 const Cart = () => {
   ...
   const [deliveryFee, setDeliveryFee] = useState(0); // Delivery fee as a whole
   ...
   const fetchCartData = async () => {
     try {
       ...
       if (response.data && response.data.items) {
         ...
         setDeliveryFee(30); // Set the delivery fee here (e.g., 30 Br or dynamically from API)
       } else {
                   ...
                   <div className="border-t border-gray-200 pt-4">
                     <div className="flex justify-between items-center">
                       ...
                       <span className="text-xl font-bold text-indigo-600">
                         {(calculateSubtotal() + deliveryFee).toLocaleString()}{' '}
                         Br
                       </span>
                     </div>
                   </div>
