  ...
  const services = [
    {
      ...
      description:
        'Elegant and memorable wedding catering services with customizable menus and professional staff.',
    ...
    },
    {
      ...
      description:
        'Fun and festive catering for birthday celebrations of all ages.',
    ...
    },
    {
      ...
      title: 'Custom Menus',
      description:
        'Tailored menus to suit your specific preferences and dietary requirements.',
              ...
              >
                <div className="p-8">
                  <div className="flex items-center space-x-4 mb-6">
                    <div
                      className={`rounded-xl p-4 ${service.color} transform hover:scale-110 transition-transform duration-300`}
                    >
                      {service.icon}
                    </div>
                ...
                <div className="space-y-5">
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-gray-600 text-lg">
                      Bookings must be confirmed two weeks in advance for proper
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-gray-600 text-lg">
                      40% non-refundable pre-payment required to secure booking.
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <p className="text-gray-600 text-lg">
                      For urgent bookings (e.g., birthday events), 100% upfront
                      payment required. Non-refundable.
                    </p>
                  </div>
                </div>
              </div>
